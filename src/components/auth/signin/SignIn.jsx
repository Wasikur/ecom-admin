    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100 p-10">
      ...
      <main className="w-full max-w-sm p-6 bg-white rounded-lg shadow-md">
        ...
        <button
          ...
          className={`w-full flex items-center justify-center gap-x-3 py-2.5 mt-6 border rounded-md text-sm font-medium ${
            isSigningIn ? "cursor-not-allowed" : "hover:bg-gray-100"
          }`}
        >
          <svg
            className="w-5 h-5"
